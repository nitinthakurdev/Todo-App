    ...
    <SafeAreaView className="flex h-full items-center justify-between bg-white ">
      <View className="flex-1 items-center justify-center px-2 w-full  ">
        ...
        <Text className="text-3xl text-black font-bold mx-10 text-center ">
          The Perfect Todo App is just a tap Away
        </Text>
        <Text className="text-md text-center text-[#858585] mx-10 mt-5">
          A To-Do App helps users manage tasks effectively by allowing them to
          create, update, delete, and organize their tasks
        </Text>
      </View>
      <View className="w-full  items-end justify-end pb-10 px-5">
        <Button
          style=" px-5 py-2 bg-button rounded-lg "
          textStyle="text-black text-lg font-semibold text-white "
          text="Next"
