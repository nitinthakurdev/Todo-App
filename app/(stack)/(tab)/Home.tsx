  ...
  return (
    <ScrollView className="flex-1 bg-white">
      <View className="flex flex-row justify-between px-7 py-3 items-center  ">
        ...
        <TouchableHighlight
          className="h-12 w-12 p-1 bg-green-500 rounded-full justify-center items-center"
      ...
      <View className="px-7 py-4 flex-1 ">
        ...
        <View className="w-full h-full py-10 ">
          <View className=" flex flex-row justify-between items-center">
            <ImageBackground
              source={image.all}
              className="h-40 w-[48%] rounded-lg p-3 overflow-hidden"
              resizeMode="cover"
            >
              <Text className="text-xl font-medium ">Total tasks </Text>
              <Text className="text-4xl font-medium  text-center pt-5">
                10{' '}
              </Text>
            </ImageBackground>
            <ImageBackground
            ...
            >
              ...
              <Text className="text-4xl font-medium text-white text-center pt-5">
                10{' '}
              </Text>
            </ImageBackground>
          </View>
